...
class PaddlePayment extends PaymentInterface
{
    protected static $view = "wave::checkout";
    ...
    {
        return view(static::$view)->render();
    }
    ...
    protected function cancelSubscription($subscription_id){
