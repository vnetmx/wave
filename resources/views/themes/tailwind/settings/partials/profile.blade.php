	...
	<div class="relative flex flex-col px-10 py-8 lg:flex-row">
		...
		<div class="w-full lg:w-9/12 xl:w-4/5">
			...
			<div class="mt-5">
				...
				<div class="mt-1 rounded-md shadow-sm">
					<input id="email" type="text" name="email" placeholder="{{__("Email  Address")}}"
            ...
            <div class="mt-5">
                <label for="company" class="block text-sm font-medium leading-5 text-gray-700">{{__("Company")}}</label>
                <div class="mt-1 rounded-md shadow-sm">
                    {!! wave_key_value('text', "company", Auth::user()->company) !!}
                </div>
            </div>

            <div class="mt-5">
                <label for="rfc" class="block text-sm font-medium leading-5 text-gray-700">{{__("RFC")}}</label>
                <div class="mt-1 rounded-md shadow-sm">
                    {!! wave_key_value('text', "rfc", Auth::user()->rfc) !!}
                </div>
            </div>

			<div class="mt-5">
				<label for="about" class="block text-sm font-medium leading-5 text-gray-700">{{__('About')}}</label>
			...
			<div class="flex justify-end w-full">
				<button class="flex self-end justify-center w-auto px-4 py-2 mt-5 text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-wave-600 hover:bg-wave-500 focus:outline-none focus:border-wave-700 focus:shadow-outline-wave active:bg-wave-700"
                        dusk="update-profile-button">{{__("Save")}}</button>
			</div>
		</div>
	</div>
